...
@Component({
  selector: 'app-relevamiento-modificar',
  templateUrl: './relevamiento-modificar.component.html',
  styleUrls: ['./relevamiento-modificar.component.css']
})
export class RelevamientoModificarComponent implements OnInit {
  ...
  registrar(){
    ...
    if($("#selectorFoto").val() !== ''){
      ...
      formData.append('cantidadFotos', this.relevamientoActual.cantidadFotos);
    }
