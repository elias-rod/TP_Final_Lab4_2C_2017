...
export class RutasService {
  /*public rutaFotosUsuarios: string = "https://tp2017utn.000webhostapp.com/api/fotosUsuarios/";
  public rutaAPI: string = "https://tp2017utn.000webhostapp.com/api/index.php/";
  public rutaFotosRelevamientos: string = "https://tp2017utn.000webhostapp.com/api/fotosRelevamientos/";
  */
